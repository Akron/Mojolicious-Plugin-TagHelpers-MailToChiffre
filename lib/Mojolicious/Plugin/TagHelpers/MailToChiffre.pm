...
and tries to be compatible with L<http://tools.ietf.org/html/rfc2368 RFC2368>,
...
L<http://www.theguardian.com/technology/2010/dec/21/keeping-email-address-secret-spambots useful at all>.


=head2 Mailto Obfuscation

The mailto obfuscation merely follows the basic principle of
L<http://alistapart.com/article/gracefulemailobfuscation this alistapart.com article>.
...
L<http://techblog.tilllate.com/2008/07/20/ten-methods-to-obfuscate-e-mail-addresses-compared/ reversed directionality> and non-displayed span segments.
...
as defined in L<http://tools.ietf.org/html/rfc2368 RFC2368>.
